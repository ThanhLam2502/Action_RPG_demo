...
namespace TopdownRPG.Character
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private void UpdateMovementState()
        {
            ...
            bool isMovementLaterally = IsMovingLaterally();
            
            PlayerMovementState lateralState = isMovementInput || isMovementLaterally ? PlayerMovementState.Running :  PlayerMovementState.Idling;
